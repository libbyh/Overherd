package ui.authormap.viz.control;
...
/**
 * Sets up various click controls for a node.
 * 
 * When clicking a neighboring node for a centered node, it should show the conversations and keywords 
