...
#output file name
#out_file="forumTree6a.xml"
out_file="firumTree_Scrambled.xml"
...
#  puts data_array
  ...
  temp=Rot13.new(data_array[5], ROT_NUM)
  branch2.add_element("attribute","name"=>"name","value"=>temp)#data_array[5])
  
  temp=Rot13.new(data_array[4], ROT_NUM)
  puts "adding " + temp#data_array[4]
  branch2.add_element("attribute","name"=>"message_id","value"=>temp)#data_array[4])
  
  puts "adding " + data_array[5]
  temp=Rot13.new(data_array[5], ROT_NUM)
  branch2.add_element("attribute","name"=>"message_title", "value"=>temp)#data_array[5])
  ...
  temp=Rot13.new(data_array[10], ROT_NUM)
  branch2.add_element("attribute","name"=>"author","value"=>temp)#data_array[10])
...
doc.root.elements["declarations"].add_element("attributeDecl", {"name"=>"author","type"=>"String"})
...
forums_array.each{|forum|
 ...
 temp=Rot13.new(forum[2], ROT_NUM)
 branch2.add_element("attribute", "name"=>"name","value"=>temp)#forum[2])
 
 temp=Rot13.new(forum[2], ROT_NUM)
 branch2.add_element("attribute","name"=>"forum_title", "value"=>temp)#forum[2])
...
# puts "date: " + temp_date
 ...
 temp=Rot13.new(forum[5], ROT_NUM)
 branch2.add_element("attribute","name"=>"forum_short", "value"=>temp)#forum[5])
 
 temp=Rot13.new(forum[4], ROT_NUM)
 branch2.add_element("attribute","name"=>"author", "value"=>temp)#forum[4]);
...
# puts temp_extended
 temp=Rot13.new(temp_extended, ROT_NUM)
 branch2.add_element("attribute","name"=>"forum_extended", "value"=>temp)#forum[6])
}
...
topics_array.each {|topic|
  ...
  temp=Rot13.new(topic[3], ROT_NUM)
  branch4.add_element("attribute","name"=>"name", "value"=>temp)#topic[3])
  puts "Adding topic " + topic[2] + " " + topic[3]
  
  temp=Rot13.new(topic[3], ROT_NUM)
  branch4.add_element("attribute","name"=>"topic_title", "value"=>temp)#topic[3])
  ...
  temp=Rot13.new(topic[5], ROT_NUM)
  branch4.add_element("attribute","name"=>"author","value"=>temp)#topic[5])
  
  temp=Rot13.new(topic[6], ROT_NUM)
  branch4.add_element("attribute","name"=>"topic_short","value"=>temp)#topic[6])
  
  temp=Rot13.new(topic[7], ROT_NUM)
  branch4.add_element("attribute","name"=>"topic_extended","value"=>temp)#topic[7])
